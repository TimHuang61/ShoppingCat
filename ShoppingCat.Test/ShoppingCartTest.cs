...
namespace ShoppingCat.Test
{
    ...
    public class ShoppingCartTest
    {
        ...
        [Test]
        public void Buy_The_First_100_and_The_Second_2_Should_10180()
        {
            //arrange
            var books = new List<Book>
            {
            ...
            //assert
            actual.Should().Be(10180);
        }

        [Test]
        public void Buy_The_First_100_and_The_Second_2_The_Third_2_Should_10260()
        {
            //arrange
            var books = new List<Book>
            {
